...
-- ---------- greetings (Home greeting cycle, 2026-07-16) ----------
-- text_hi = Devanagari as spoken; text_en = transliteration (NOT a
-- translation — the greeting is the same word in both modes). Traditional
-- forms only, never a political slogan (CLAUDE.md fence-line).
insert into devotional_items (id, kind, deity_id, text_hi, text_en, source, status) values
