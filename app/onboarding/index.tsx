...
type StepId =
  | "language" | "goal" | "body_focus" | "level" | "days" | "age" | "diet" | "mode" | "deity" | "consent" | "ready";

const STEPS: StepId[] = ["language", "goal", "body_focus", "level", "days", "age", "diet", "mode", "deity", "consent", "ready"];
